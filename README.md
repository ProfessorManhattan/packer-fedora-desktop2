...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://github.com/ProfessorManhattan/packer-fedora-desktop" title="GitHub mirror" target="_blank">
  ...
  <p align="center">
    <a href="https://gitlab.com/megabyte-labs/npm/fedora-desktop" target="_blank">
      <img alt="Version: 1.0.0" src="https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/packer/fedora-desktop/commits/master" target="_blank">
      <img alt="Pipeline status" src="https://gitlab.com/megabyte-labs/packer/fedora-desktop/badges/master/pipeline.svg">
    </a>
    <a href="https://gitlab.com/megabyte-labs/packer/fedora-desktop" target="_blank">
...
This repository contains the source code used to automatically build minimal Fedora Workstation 34 VM images. The build process closely imitates the same process used by [chef/bento](https://github.com/chef/bento). In fact, you will see that most of the `scripts/` folder is symlinked to a chef/bento submodule.

This repository automates most of the process of keeping our [Fedora Workstation 34 VM images](https://app.vagrantup.com/Megabyte/boxes/Fedora-Desktop) up-to-date with the latest upstream source by:
...
You can quickly use this project to create your own minimal Fedora Workstation 34 box by:
...
If a new release of the Fedora Workstation 34 system is available, you can update your VagrantUp box. You can do this by changing the `"iso_checksum_url"`, `"iso_url"`, and `"iso_version"` variables in the `template.json` file. After that, run `packer build -only=virtualbox-iso template.json` and you should be golden.
...
latestos fedora # Options include arch, centos, debian, fedora, and ubuntu
packer build -only=virtualbox-iso template.json
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-labs/packer/Fedora-Desktop/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-labs/packer/Fedora-Desktop/-/blob/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/packer/Fedora-Desktop/-/raw/master/LICENSE) licensed.
